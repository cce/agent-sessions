...
use commands::{get_all_sessions, focus_session, update_tray_title, register_shortcut, unregister_shortcut, kill_session, get_ignore_cpu_setting, set_ignore_cpu_setting};
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![get_all_sessions, focus_session, update_tray_title, register_shortcut, unregister_shortcut, kill_session, get_ignore_cpu_setting, set_ignore_cpu_setting])
        .setup(|app| {
